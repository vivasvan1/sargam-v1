...
const LEGEND_ITEMS: LegendItem[] = [
    ...
    },
    {
        label: "Lower Octave",
        symbol: "S,",
        description: "A comma (or dot below) indicates the lower octave (Mandra Saptak).",
        event: { swara: "S", octave: -1, startTime: 0, durationSeconds: 0.8 }
    },
    {
        label: "Upper Octave",
        symbol: "S'",
        description: "An apostrophe (or dot above) indicates the upper octave (Taar Saptak).",
        event: { swara: "S", octave: 1, startTime: 0, durationSeconds: 0.8 }
    },
    {
        label: "Komal Ni",
            ...
            <DialogContent className="sm:max-w-[500px] max-h-[80vh] overflow-y-auto">
                ...
                <div className="grid gap-4 py-4">
                    {LEGEND_ITEMS.map((item, idx) => (
                        <div key={idx} className="flex items-start gap-4 p-3 rounded-lg hover:bg-muted/10 transition-colors group">
                ...
                <div className="pt-4 border-t border-border/40">
                    <p className="text-[10px] text-muted-foreground text-center italic">
                        Tip: You can also tap and hold notes in the visualizer to see their full names.
                    </p>
                </div>
            </DialogContent>
        </Dialog>
