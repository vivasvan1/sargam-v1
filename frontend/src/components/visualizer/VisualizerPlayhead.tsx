...
export const VisualizerPlayhead = forwardRef<
  HTMLDivElement,
  VisualizerPlayheadProps
>(({ lineProgress, pixelsPerSecond }, ref) => {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-primary rounded-full" />
    </div>
  );
});
