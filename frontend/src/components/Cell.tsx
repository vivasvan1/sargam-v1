      ...
      <div className="px-3 md:px-4 py-2 border-b border-border bg-muted/30 flex items-center justify-between min-w-0">
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            variant="ghost"
            size="icon-sm"
            className="opacity-100 md:opacity-0 md:group-hover/cell:opacity-100 text-muted-foreground hover:text-primary shrink-0 min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 touch-manipulation"
          ...
          <Button
            ...
            variant="ghost"
            size="icon-sm"
            className="opacity-100 md:opacity-0 md:group-hover/cell:opacity-100 hover:bg-destructive/10 text-muted-foreground hover:text-destructive shrink-0 min-w-[44px] min-h-[44px] md:min-w-0 md:min-h-0 touch-manipulation"
